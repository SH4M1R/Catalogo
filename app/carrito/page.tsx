...
export default function CarritoPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#f7f7f7] pb-[calc(9rem+env(safe-area-inset-bottom))] md:pb-20 font-sans">
      {/* HEADER COMPACTO */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-6">
            ...
            <aside className="hidden lg:block px-4 md:px-0">
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-28">
                <h2 className="text-lg font-bold text-zinc-800 mb-4 uppercase tracking-tighter">
                  Resumen del pedido
                </h2>
      ...
      {carrito.length > 0 && (
        <div
          className="lg:hidden fixed left-0 right-0 bg-white border-t border-gray-100 p-4 z-40 flex items-center justify-between shadow-[0_-5px_15px_rgba(0,0,0,0.05)]"
          style={{ bottom: "calc(4rem + env(safe-area-inset-bottom))" }}
        >
          <div className="flex flex-col">
            <div className="flex items-center gap-1">
              <span className="text-xs text-zinc-400">Total</span>
              <span className="text-[10px] bg-green-100 text-green-700 px-1 rounded font-bold">
                Envío Gratis
              </span>
            </div>
